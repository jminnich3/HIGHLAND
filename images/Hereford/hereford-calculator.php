...
<body>
    <div class="calculator">
        ...
        <div class="breed-tabs">
            ...
            <a href="hereford-calculator.php" class="breed-tab active">Hereford Cattle</a>
        </div>
        ...
        <div class="gene-summary">
            ...
            <div class="gene-info">
                ...
                <ul class="allele-list">
                    ...
                    <li><strong>E/_ + W/_ (Black Hereford):</strong> Black body with white face pattern. Common in Black Hereford associations (Hereford × Angus crosses).</li>
    ...
    <script src="js/hereford-calculator.js"></script>
</body>
</html>
