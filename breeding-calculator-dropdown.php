...
?>
    <style>
        ...
        .color-dropdown-container.hidden {
            display: none;
        }
...
<body>
    <div class="calculator">
        ...
        <h1>Highland Cattle Breeding Calculator (Dropdown)</h1>
        ...
        <div class="parent-section">
            <div class="parent-card">
                <h2>Sire</h2>
                <div class="color-dropdown-container" id="parent1DropdownContainer">
                    <select class="color-dropdown" id="parent1ColorDropdown">
            ...
            <div class="parent-card">
                <h2>Dam</h2>
                <div class="color-dropdown-container" id="parent2DropdownContainer">
                    <select class="color-dropdown" id="parent2ColorDropdown">
                        <option value="">Select a color...</option>
                    </select>
                </div>
    ...
    <script src="js/breeding-calculator-dropdown.js"></script>
</body>
</html>
